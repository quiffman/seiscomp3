...
class Application(Core.InterruptibleObject):
    ...
    def handleInterrupt(self, *args):
        """handleInterrupt(self, int arg0)"""
        return _Client.Application_handleInterrupt(self, *args)
    ...
    def configGetBools(self, *args):
        """configGetBools(self, string query) -> std::vector<(bool,std::allocator<(bool)>)>"""
    ...
    def configSetBools(self, *args):
        """configSetBools(self, string query, std::vector<(bool,std::allocator<(bool)>)> arg1)"""
...
class StreamApplication(Application):
    ...
    def exit(self, *args):
        """exit(self, int returnCode)"""
        return _Client.StreamApplication_exit(self, *args)
    ...
    def handleInterrupt(self, *args):
        """handleInterrupt(self, int arg0)"""
        return _Client.StreamApplication_handleInterrupt(self, *args)
