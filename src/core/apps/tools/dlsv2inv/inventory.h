...
{
	public:
		Inventory(INIT_MAP& init, Seiscomp::Communication::Connection* connection);
	...
	private:
		...
		Seiscomp::DataModel::StreamPtr InsertStream(ChannelIdentifier&, Seiscomp::DataModel::SensorLocationPtr);
		Seiscomp::DataModel::AuxStreamPtr InsertAuxStream(ChannelIdentifier&, Seiscomp::DataModel::SensorLocationPtr);
		...
		void UpdateStream(ChannelIdentifier&, Seiscomp::DataModel::StreamPtr);
		void UpdateAuxStream(ChannelIdentifier&, Seiscomp::DataModel::AuxStreamPtr);
