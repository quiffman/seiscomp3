...
class MySQLCleaner(seiscomp3.Client.Application):
  ...
  def check(self):
    try:
      ...
      if self.database().beginQuery("show tables") == False:
        return False

      while self.database().fetchRow():
        tables.append(self.database().getRowFieldString(0))
  ...
  def clean(self):
    try:
      ...
      if self.runCommand(self.deleteObjectQuery("Object", "WaveformQuality") + \
  ...
  def deleteChilds(self, *v):
    count = int(self.runQuery(self.childQuery("count", "Object", *v))[0])
    self.runCommand(self.childQuery("delete", "Object", *v))
    self.runCommand(self.childQuery("delete", None, *v))
    return count


  def deleteUnusedChilds(self, *v):
    count = int(self.runQuery(self.childQuery("count", "Object", *v) + " and used=0")[0])
    self.runCommand(self.childQuery("delete", "Object", *v) + " and used=0")
    self.runCommand(self.childQuery("delete", None, *v) + " and used=0")
    return count


  def deleteUnusedPublicChilds(self, *v):
    count = int(self.runQuery(self.childQuery("count", "Object", *v) + " and used=0")[0])
    self.runCommand(self.childJournalQuery("delete", "PublicObject", *v) + " and used=0")
    self.runCommand(self.childQuery("delete", "Object", *v) + " and used=0")
    self.runCommand(self.childQuery("delete", "PublicObject", *v) + " and used=0")
    self.runCommand(self.childQuery("delete", None, *v) + " and used=0")
    return count


  def deleteUnusedRawObjects(self, *v):
    self.runCommand(self.deleteJournalQuery("PublicObject", *v) + " and used=0")
    self.runCommand(self.deleteObjectQuery(None, "Object", *v) + " and used=0")
    self.runCommand(self.deleteObjectQuery(None, "PublicObject", *v) + " and used=0")
    return None

  def deleteObjects(self, *v):
    self.runCommand(self.deleteJournalQuery("PublicObject", *v))
    self.runCommand(self.deleteObjectQuery("Object", *v))
    self.runCommand(self.deleteObjectQuery("PublicObject", *v))
    self.runCommand(self.deleteObjectQuery(None, *v))
    return None

  def deleteUnusedObjects(self, *v):
    self.runCommand(self.deleteJournalQuery("PublicObject", *v) + " and used=0")
    self.runCommand(self.deleteObjectQuery("Object", *v) + " and used=0")
    self.runCommand(self.deleteObjectQuery("PublicObject", *v) + " and used=0")
    self.runCommand(self.deleteObjectQuery(None, *v) + " and used=0")
    return None
...
app = MySQLCleaner(len(sys.argv), sys.argv)
sys.exit(app())
