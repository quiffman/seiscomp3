...
CREATE TABLE MomentTensor (
	...
	momentMagnitudeID VARCHAR(255) NOT NULL,
	...
	clvd DOUBLE,
	iso DOUBLE,
	greensFunctionID VARCHAR(255) NOT NULL,
	...
	method VARCHAR(64),
	status VARCHAR(64),
	cmtName VARCHAR(80) NOT NULL,
	cmtVersion VARCHAR(64) NOT NULL,
	creationInfo_agencyID VARCHAR(64),
	creationInfo_agencyURI VARCHAR(255),
	creationInfo_author VARCHAR(128),
	creationInfo_authorURI VARCHAR(255),
...
CREATE TABLE FocalMechanism (
	...
	_parent_oid INTEGER(11) NOT NULL,
	_last_modified TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
	triggeringOriginID VARCHAR(255) NOT NULL,
...
CREATE TABLE Amplitude (
	...
	magnitudeHint CHAR(16) NOT NULL,
	evaluationMode VARCHAR(64),
	creationInfo_agencyID VARCHAR(64),
	creationInfo_agencyURI VARCHAR(255),
	creationInfo_author VARCHAR(128),
...
CREATE TABLE Pick (
	...
	waveformID_locationCode CHAR(8) NOT NULL,
	waveformID_channelCode CHAR(8) NOT NULL,
	waveformID_resourceURI VARCHAR(255) NOT NULL,
	filterID VARCHAR(255) NOT NULL,
	methodID VARCHAR(255) NOT NULL,
	...
	slownessMethodID VARCHAR(255) NOT NULL,
	onset VARCHAR(64),
...
CREATE TABLE Event (
	...
	_parent_oid INTEGER(11) NOT NULL,
	_last_modified TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
	preferredOriginID VARCHAR(255) NOT NULL,
	preferredMagnitudeID VARCHAR(255) NOT NULL,
	preferredFocalMechanismID VARCHAR(255) NOT NULL,
	type VARCHAR(64),
...
CREATE TABLE Arrival (
	...
	weight DOUBLE UNSIGNED,
	earthModelID VARCHAR(255) NOT NULL,
...
CREATE TABLE Origin (
	...
	referenceSystemID VARCHAR(255) NOT NULL,
	methodID VARCHAR(255) NOT NULL,
	earthModelID VARCHAR(255) NOT NULL,
...
CREATE TABLE Setup (
	...
	_last_modified TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
	name VARCHAR(20) NOT NULL,
	parameterSetID VARCHAR(80) NOT NULL,
...
CREATE TABLE AuxSource (
	...
	conversion VARCHAR(80) NOT NULL,
...
CREATE TABLE ResponsePolynomial (
	...
	gain DOUBLE UNSIGNED,
	gainFrequency DOUBLE UNSIGNED,
	frequencyUnit CHAR(1) NOT NULL,
	approximationType CHAR(1) NOT NULL,
...
CREATE TABLE Datalogger (
	...
	name VARCHAR(80) NOT NULL,
	description VARCHAR(80) NOT NULL,
	digitizerModel VARCHAR(80) NOT NULL,
	digitizerManufacturer VARCHAR(50) NOT NULL,
	recorderModel VARCHAR(80) NOT NULL,
	recorderManufacturer VARCHAR(50) NOT NULL,
	clockModel VARCHAR(80) NOT NULL,
	clockManufacturer VARCHAR(50) NOT NULL,
...
CREATE TABLE AuxStream (
	...
	deviceSerialNumber VARCHAR(80) NOT NULL,
...
CREATE TABLE Stream (
	...
	datalogger VARCHAR(80) NOT NULL,
	dataloggerSerialNumber VARCHAR(80) NOT NULL,
	dataloggerChannel INT UNSIGNED,
	sensor VARCHAR(80) NOT NULL,
	sensorSerialNumber VARCHAR(80) NOT NULL,
	sensorChannel INT UNSIGNED,
	clockSerialNumber VARCHAR(80) NOT NULL,
	sampleRateNumerator INT UNSIGNED,
	sampleRateDenominator INT UNSIGNED,
	depth DOUBLE,
	azimuth DOUBLE,
...
CREATE TABLE Station (
	...
	archiveNetworkCode CHAR(8) NOT NULL,
	restricted TINYINT(1),
	shared TINYINT(1),
	remark_content BLOB,
	remark_used TINYINT(1) NOT NULL DEFAULT 0,
...
CREATE TABLE JournalEntry (
	...
	parameters VARCHAR(160) NOT NULL,
	PRIMARY KEY(_oid),
	INDEX(objectID),
	FOREIGN KEY(_oid)
	  REFERENCES Object(_oid)
...
CREATE TABLE ArclinkRequestLine (
	...
	streamID_locationCode CHAR(8) NOT NULL,
	streamID_channelCode CHAR(8) NOT NULL,
	streamID_resourceURI VARCHAR(255) NOT NULL,
	restricted TINYINT(1),
	shared TINYINT(1),
	netClass CHAR(1) NOT NULL,
	constraints VARCHAR(160) NOT NULL,
	...
	status_volumeID VARCHAR(80) NOT NULL,
	PRIMARY KEY(_oid),
	FOREIGN KEY(_oid)
	  REFERENCES Object(_oid)
	  ON DELETE CASCADE,
