...
CREATE TABLE MomentTensor (
	...
	momentMagnitudeID VARCHAR NOT NULL,
	...
	clvd DOUBLE,
	iso DOUBLE,
	greensFunctionID VARCHAR NOT NULL,
	...
	method VARCHAR(64),
	status VARCHAR(64),
	cmtName VARCHAR NOT NULL,
	cmtVersion VARCHAR NOT NULL,
	creationInfo_agencyID VARCHAR,
	creationInfo_agencyURI VARCHAR,
	creationInfo_author VARCHAR,
	creationInfo_authorURI VARCHAR,
...
CREATE TABLE FocalMechanism (
	...
	_parent_oid INTEGER NOT NULL,
	_last_modified TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
	triggeringOriginID VARCHAR NOT NULL,
...
CREATE TABLE Pick (
	...
	waveformID_locationCode CHAR NOT NULL,
	waveformID_channelCode CHAR NOT NULL,
	waveformID_resourceURI VARCHAR NOT NULL,
	filterID VARCHAR NOT NULL,
	methodID VARCHAR NOT NULL,
...
CREATE TABLE Event (
	...
	_parent_oid INTEGER NOT NULL,
	_last_modified TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
	preferredOriginID VARCHAR NOT NULL,
	preferredMagnitudeID VARCHAR NOT NULL,
	preferredFocalMechanismID VARCHAR NOT NULL,
	type VARCHAR(64),
...
CREATE TABLE Origin (
	...
	referenceSystemID VARCHAR NOT NULL,
	methodID VARCHAR NOT NULL,
	earthModelID VARCHAR NOT NULL,
...
CREATE TABLE Setup (
	...
	_last_modified TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
	name VARCHAR NOT NULL,
	parameterSetID VARCHAR NOT NULL,
...
CREATE TABLE ResponsePolynomial (
	...
	gain DOUBLE UNSIGNED,
	gainFrequency DOUBLE UNSIGNED,
	frequencyUnit CHAR NOT NULL,
	approximationType CHAR NOT NULL,
...
CREATE TABLE Datalogger (
	...
	name VARCHAR NOT NULL,
	description VARCHAR NOT NULL,
	digitizerModel VARCHAR NOT NULL,
	digitizerManufacturer VARCHAR NOT NULL,
	recorderModel VARCHAR NOT NULL,
	recorderManufacturer VARCHAR NOT NULL,
	clockModel VARCHAR NOT NULL,
	clockManufacturer VARCHAR NOT NULL,
	clockType VARCHAR NOT NULL,
	gain DOUBLE UNSIGNED,
...
CREATE TABLE AuxStream (
	...
	deviceSerialNumber VARCHAR NOT NULL,
...
CREATE TABLE Stream (
	...
	dataloggerSerialNumber VARCHAR NOT NULL,
	dataloggerChannel INT UNSIGNED,
	sensor VARCHAR NOT NULL,
	sensorSerialNumber VARCHAR NOT NULL,
	sensorChannel INT UNSIGNED,
	clockSerialNumber VARCHAR NOT NULL,
	sampleRateNumerator INT UNSIGNED,
	sampleRateDenominator INT UNSIGNED,
	depth DOUBLE,
	azimuth DOUBLE,
...
CREATE TABLE Station (
	...
	archiveNetworkCode CHAR NOT NULL,
	restricted INTEGER(1),
	shared INTEGER(1),
	remark_content BLOB,
	remark_used INTEGER(1) NOT NULL DEFAULT '0',
...
CREATE TABLE ArclinkRequestLine (
	...
	streamID_locationCode CHAR NOT NULL,
	streamID_channelCode CHAR NOT NULL,
	streamID_resourceURI VARCHAR NOT NULL,
	restricted INTEGER(1),
	shared INTEGER(1),
	netClass CHAR NOT NULL,
	...
	status_volumeID VARCHAR NOT NULL,
	PRIMARY KEY(_oid),
	FOREIGN KEY(_oid)
	  REFERENCES Object(_oid)
	  ON DELETE CASCADE,
