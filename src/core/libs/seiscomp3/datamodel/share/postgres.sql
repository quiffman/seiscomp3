...
CREATE TABLE PublicObject (
	...
	m_publicID VARCHAR(80) NOT NULL,
	PRIMARY KEY(_oid),
	UNIQUE(m_publicID),
	FOREIGN KEY(_oid)
...
CREATE TABLE Comment (
	...
	m_creationInfo_used SMALLINT NOT NULL DEFAULT 0,
	PRIMARY KEY(_oid),
	FOREIGN KEY(_oid)
	  REFERENCES Object(_oid)
	  ON DELETE CASCADE,
...
CREATE TABLE CompositeTime (
	...
	m_minute_used SMALLINT NOT NULL DEFAULT 0,
	...
	m_second_used SMALLINT NOT NULL DEFAULT 0,
	PRIMARY KEY(_oid),
	FOREIGN KEY(_oid)
	  REFERENCES Object(_oid)
	  ON DELETE CASCADE,
...
CREATE TABLE MomentTensorStationContribution (
	...
	m_waveformID_used SMALLINT NOT NULL DEFAULT 0,
...
CREATE TABLE MomentTensor (
	...
	m_momentMagnitudeID VARCHAR(255) NOT NULL,
	...
	m_scalarMoment_used SMALLINT NOT NULL DEFAULT 0,
	...
	m_tensor_used SMALLINT NOT NULL DEFAULT 0,
	...
	m_greensFunctionID VARCHAR(255) NOT NULL,
	m_filterID VARCHAR(255) NOT NULL,
	...
	m_sourceTimeFunction_used SMALLINT NOT NULL DEFAULT 0,
	m_methodID VARCHAR(255) NOT NULL,
	m_method VARCHAR(64),
	m_status VARCHAR(64),
	m_cmtName VARCHAR(80) NOT NULL,
	m_cmtVersion VARCHAR(64) NOT NULL,
	m_creationInfo_agencyID VARCHAR(64),
	m_creationInfo_agencyURI VARCHAR(255),
	m_creationInfo_author VARCHAR(128),
	m_creationInfo_authorURI VARCHAR(255),
...
CREATE TABLE FocalMechanism (
	...
	_parent_oid BIGINT NOT NULL,
	_last_modified TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
	m_triggeringOriginID VARCHAR(255) NOT NULL,
	...
	m_nodalPlanes_nodalPlane1_used SMALLINT NOT NULL DEFAULT 0,
	...
	m_nodalPlanes_nodalPlane2_used SMALLINT NOT NULL DEFAULT 0,
	m_nodalPlanes_preferredPlane INT,
	m_nodalPlanes_used SMALLINT NOT NULL DEFAULT 0,
	...
	m_principalAxes_nAxis_used SMALLINT NOT NULL DEFAULT 0,
	m_principalAxes_used SMALLINT NOT NULL DEFAULT 0,
...
CREATE TABLE Amplitude (
	...
	m_amplitude_used SMALLINT NOT NULL DEFAULT 0,
	...
	m_timeWindow_used SMALLINT NOT NULL DEFAULT 0,
	...
	m_period_used SMALLINT NOT NULL DEFAULT 0,
	m_snr DOUBLE PRECISION,
	m_pickID VARCHAR(255) NOT NULL,
	m_waveformID_networkCode VARCHAR(8),
	m_waveformID_stationCode VARCHAR(8),
	...
	m_scalingTime_used SMALLINT NOT NULL DEFAULT 0,
	m_magnitudeHint VARCHAR(16) NOT NULL,
	m_evaluationMode VARCHAR(64),
	m_creationInfo_agencyID VARCHAR(64),
	m_creationInfo_agencyURI VARCHAR(255),
	m_creationInfo_author VARCHAR(128),
...
CREATE TABLE Pick (
	...
	m_waveformID_locationCode VARCHAR(8) NOT NULL,
	m_waveformID_channelCode VARCHAR(8) NOT NULL,
	m_waveformID_resourceURI VARCHAR(255) NOT NULL,
	m_filterID VARCHAR(255) NOT NULL,
	m_methodID VARCHAR(255) NOT NULL,
	...
	m_horizontalSlowness_used SMALLINT NOT NULL DEFAULT 0,
	...
	m_backazimuth_used SMALLINT NOT NULL DEFAULT 0,
	m_slownessMethodID VARCHAR(255) NOT NULL,
	m_onset VARCHAR(64),
	m_phaseHint_code VARCHAR(32),
	m_phaseHint_used SMALLINT NOT NULL DEFAULT 0,
...
CREATE TABLE Event (
	...
	_parent_oid BIGINT NOT NULL,
	_last_modified TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
	m_preferredOriginID VARCHAR(255) NOT NULL,
	m_preferredMagnitudeID VARCHAR(255) NOT NULL,
	m_preferredFocalMechanismID VARCHAR(255) NOT NULL,
	m_type VARCHAR(64),
...
CREATE TABLE Arrival (
	...
	m_timeUsed SMALLINT,
	m_horizontalSlownessUsed SMALLINT,
	m_backazimuthUsed SMALLINT,
	m_weight DOUBLE PRECISION,
	m_earthModelID VARCHAR(255) NOT NULL,
	m_preliminary SMALLINT,
	m_creationInfo_agencyID VARCHAR(64),
	m_creationInfo_agencyURI VARCHAR(255),
	m_creationInfo_author VARCHAR(128),
	m_creationInfo_authorURI VARCHAR(255),
...
CREATE TABLE Origin (
	...
	m_depth_used SMALLINT NOT NULL DEFAULT 0,
	m_depthType VARCHAR(64),
	m_timeFixed SMALLINT,
	m_epicenterFixed SMALLINT,
	m_referenceSystemID VARCHAR(255) NOT NULL,
	m_methodID VARCHAR(255) NOT NULL,
	m_earthModelID VARCHAR(255) NOT NULL,
	...
	m_quality_used SMALLINT NOT NULL DEFAULT 0,
	...
	m_uncertainty_confidenceEllipsoid_used SMALLINT NOT NULL DEFAULT 0,
	m_uncertainty_preferredDescription VARCHAR(64),
	m_uncertainty_used SMALLINT NOT NULL DEFAULT 0,
	m_type VARCHAR(64),
	m_evaluationMode VARCHAR(64),
	m_evaluationStatus VARCHAR(64),
	m_creationInfo_agencyID VARCHAR(64),
...
CREATE TABLE ParameterSet (
	...
	_parent_oid BIGINT NOT NULL,
	_last_modified TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
	m_baseID VARCHAR(80) NOT NULL,
	m_moduleID VARCHAR(80) NOT NULL,
	m_created TIMESTAMP,
...
CREATE TABLE Setup (
	...
	_last_modified TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
	m_name VARCHAR(20) NOT NULL,
	m_parameterSetID VARCHAR(80) NOT NULL,
	m_enabled SMALLINT NOT NULL,
	PRIMARY KEY(_oid),
	FOREIGN KEY(_oid)
	  REFERENCES Object(_oid)
	  ON DELETE CASCADE,
...
CREATE TABLE QCLog (
	...
	m_waveformID_channelCode VARCHAR(8) NOT NULL,
	m_waveformID_resourceURI VARCHAR(255) NOT NULL,
	m_creatorID VARCHAR(80) NOT NULL,
...
CREATE TABLE StationGroup (
	...
	m_start TIMESTAMP,
	m_end TIMESTAMP,
	m_description VARCHAR(80) NOT NULL,
...
CREATE TABLE Sensor (
	...
	m_response VARCHAR(80) NOT NULL,
	m_remark_content BYTEA,
	m_remark_used SMALLINT NOT NULL DEFAULT 0,
	PRIMARY KEY(_oid),
	FOREIGN KEY(_oid)
...
CREATE TABLE ResponsePAZ (
	...
	m_zeros_used SMALLINT NOT NULL DEFAULT 0,
	m_poles_content BYTEA,
	m_poles_used SMALLINT NOT NULL DEFAULT 0,
	m_remark_content BYTEA,
	m_remark_used SMALLINT NOT NULL DEFAULT 0,
	PRIMARY KEY(_oid),
	FOREIGN KEY(_oid)
...
CREATE TABLE ResponsePolynomial (
	...
	m_gain DOUBLE PRECISION,
	m_gainFrequency DOUBLE PRECISION,
	m_frequencyUnit VARCHAR(1) NOT NULL,
	m_approximationType VARCHAR(1) NOT NULL,
	...
	m_coefficients_used SMALLINT NOT NULL DEFAULT 0,
	m_remark_content BYTEA,
	m_remark_used SMALLINT NOT NULL DEFAULT 0,
	PRIMARY KEY(_oid),
	FOREIGN KEY(_oid)
...
CREATE TABLE Decimation (
	...
	m_analogueFilterChain_used SMALLINT NOT NULL DEFAULT 0,
	m_digitalFilterChain_content BYTEA,
	m_digitalFilterChain_used SMALLINT NOT NULL DEFAULT 0,
	PRIMARY KEY(_oid),
	FOREIGN KEY(_oid)
	  REFERENCES Object(_oid)
	  ON DELETE CASCADE,
...
CREATE TABLE Datalogger (
	...
	m_name VARCHAR(80) NOT NULL,
	m_description VARCHAR(80) NOT NULL,
	m_digitizerModel VARCHAR(80) NOT NULL,
	m_digitizerManufacturer VARCHAR(50) NOT NULL,
	m_recorderModel VARCHAR(80) NOT NULL,
	m_recorderManufacturer VARCHAR(50) NOT NULL,
	m_clockModel VARCHAR(80) NOT NULL,
	m_clockManufacturer VARCHAR(50) NOT NULL,
	m_clockType VARCHAR(10) NOT NULL,
	m_gain DOUBLE PRECISION,
...
CREATE TABLE AuxStream (
	...
	m_start TIMESTAMP NOT NULL,
	m_end TIMESTAMP,
	m_device VARCHAR(80) NOT NULL,
	m_deviceSerialNumber VARCHAR(80) NOT NULL,
	m_source VARCHAR(80) NOT NULL,
	m_format VARCHAR(20) NOT NULL,
	m_flags VARCHAR(20) NOT NULL,
	m_restricted SMALLINT,
	m_shared SMALLINT,
	PRIMARY KEY(_oid),
	FOREIGN KEY(_oid)
	  REFERENCES Object(_oid)
...
CREATE TABLE Stream (
	...
	m_start TIMESTAMP NOT NULL,
	m_end TIMESTAMP,
	m_datalogger VARCHAR(80) NOT NULL,
	m_dataloggerSerialNumber VARCHAR(80) NOT NULL,
	m_dataloggerChannel INT,
	m_sensor VARCHAR(80) NOT NULL,
	m_sensorSerialNumber VARCHAR(80) NOT NULL,
	m_sensorChannel INT,
	m_clockSerialNumber VARCHAR(80) NOT NULL,
	m_sampleRateNumerator INT,
	m_sampleRateDenominator INT,
	...
	m_gain DOUBLE PRECISION,
	m_gainFrequency DOUBLE PRECISION,
	m_gainUnit VARCHAR(20) NOT NULL,
	m_format VARCHAR(20) NOT NULL,
	m_flags VARCHAR(20) NOT NULL,
	m_restricted SMALLINT,
	m_shared SMALLINT,
...
CREATE TABLE Station (
	...
	m_longitude DOUBLE PRECISION,
	m_elevation DOUBLE PRECISION,
	m_place VARCHAR(80) NOT NULL,
	m_country VARCHAR(50) NOT NULL,
	m_affiliation VARCHAR(50) NOT NULL,
	m_type VARCHAR(50) NOT NULL,
	m_archive VARCHAR(20) NOT NULL,
	m_archiveNetworkCode VARCHAR(8) NOT NULL,
	m_restricted SMALLINT,
	m_shared SMALLINT,
	m_remark_content BYTEA,
	m_remark_used SMALLINT NOT NULL DEFAULT 0,
...
CREATE TABLE Network (
	...
	m_end TIMESTAMP,
	m_description VARCHAR(80) NOT NULL,
	m_institutions VARCHAR(100) NOT NULL,
	m_region VARCHAR(100) NOT NULL,
	m_type VARCHAR(50) NOT NULL,
	m_netClass VARCHAR(1) NOT NULL,
	m_archive VARCHAR(20) NOT NULL,
	m_restricted SMALLINT,
	m_shared SMALLINT,
	m_remark_content BYTEA,
...
CREATE TABLE JournalEntry (
	...
	m_created TIMESTAMP,
	m_created_ms INTEGER,
	m_objectID VARCHAR(80) NOT NULL,
	m_sender VARCHAR(80) NOT NULL,
	m_action VARCHAR(160) NOT NULL,
	m_parameters VARCHAR(160) NOT NULL,
	PRIMARY KEY(_oid),
	FOREIGN KEY(_oid)
	  REFERENCES Object(_oid)
	  ON DELETE CASCADE,
...
CREATE TABLE ArclinkUser (
	...
	m_password VARCHAR(80) NOT NULL,
	PRIMARY KEY(_oid),
	FOREIGN KEY(_oid)
	  REFERENCES Object(_oid)
	  ON DELETE CASCADE,
...
CREATE TABLE ArclinkStatusLine (
	...
	m_size INT,
	m_message VARCHAR(160) NOT NULL,
	m_volumeID VARCHAR(80) NOT NULL,
	PRIMARY KEY(_oid),
	FOREIGN KEY(_oid)
	  REFERENCES Object(_oid)
	  ON DELETE CASCADE,
...
CREATE TABLE ArclinkRequestLine (
	...
	m_streamID_locationCode VARCHAR(8) NOT NULL,
	m_streamID_channelCode VARCHAR(8) NOT NULL,
	m_streamID_resourceURI VARCHAR(255) NOT NULL,
	m_restricted SMALLINT,
	m_shared SMALLINT,
	m_netClass VARCHAR(1) NOT NULL,
	m_constraints VARCHAR(160) NOT NULL,
	m_status_type VARCHAR(80) NOT NULL,
	m_status_status VARCHAR(160) NOT NULL,
	m_status_size INT,
	m_status_message VARCHAR(160) NOT NULL,
	m_status_volumeID VARCHAR(80) NOT NULL,
	PRIMARY KEY(_oid),
	FOREIGN KEY(_oid)
	  REFERENCES Object(_oid)
	  ON DELETE CASCADE,
...
CREATE TABLE ArclinkRequest (
	...
	_parent_oid BIGINT NOT NULL,
	_last_modified TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
	m_requestID VARCHAR(80) NOT NULL,
	m_userID VARCHAR(80) NOT NULL,
	m_userIP VARCHAR(16) NOT NULL,
	m_clientID VARCHAR(80) NOT NULL,
	m_clientIP VARCHAR(16) NOT NULL,
	m_type VARCHAR(80) NOT NULL,
	m_created TIMESTAMP NOT NULL,
	m_created_ms INTEGER NOT NULL,
	m_status VARCHAR(80) NOT NULL,
	m_message VARCHAR(160) NOT NULL,
	m_label VARCHAR(80) NOT NULL,
	m_header VARCHAR(160) NOT NULL,
	m_summary_okLineCount INT,
	m_summary_totalLineCount INT,
	m_summary_averageTimeWindow INT,
	m_summary_used SMALLINT NOT NULL DEFAULT 0,
	PRIMARY KEY(_oid),
	FOREIGN KEY(_oid)
	  REFERENCES Object(_oid)
	  ON DELETE CASCADE,
