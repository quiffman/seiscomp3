...
class SC_CORE_DATAMODEL_API Observer : public Seiscomp::Core::BaseObject {
...
class SC_CORE_DATAMODEL_API Visitor {
	public:
		enum TraversalMode {
			TM_TOPDOWN,
			TM_BOTTOMUP,
...
class SC_CORE_DATAMODEL_API Object : public Core::BaseObject {
