...
DEFINE_MESSAGE_FOR(Seiscomp::DataModel::Notifier, NotifierMessage, SC_CORE_DATAMODEL_API);

class SC_CORE_DATAMODEL_API Notifier : public Seiscomp::Core::BaseObject {
