...
#include <seiscomp3/seismology/api.h>
...
class SC_CORE_SEISMOLOGY_API FileNotFoundError : public std::exception {
	public:
...
class SC_CORE_SEISMOLOGY_API MultipleModelsError : public std::exception {
	public:
...
class SC_CORE_SEISMOLOGY_API NoPhaseError : public std::exception {
	public:
		NoPhaseError() throw() {}
		~NoPhaseError() throw() {}
		const char* what() const throw() { 
 ...
 */
class SC_CORE_SEISMOLOGY_API TravelTime {
	public:
		TravelTime();
 ...
 */
class SC_CORE_SEISMOLOGY_API TravelTimeList : public  std::list<TravelTime> {
	public:
...
class SC_CORE_SEISMOLOGY_API TravelTimeTableInterface : public Core::BaseObject {
	public:
		TravelTimeTableInterface();
...
class SC_CORE_SEISMOLOGY_API TravelTimeTable : public TravelTimeTableInterface {
	public:
		TravelTimeTable();
