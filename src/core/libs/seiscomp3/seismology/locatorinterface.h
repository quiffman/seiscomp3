...
class SC_CORE_SEISMOLOGY_API SensorLocationDelegate : public Core::BaseObject {
	public:
...
class SC_CORE_SEISMOLOGY_API LocatorInterface : public Core::BaseObject {
	public:
...
class SC_CORE_SEISMOLOGY_API PickNotFoundException : public Core::GeneralException {
	public:
		PickNotFoundException();
		PickNotFoundException(const std::string& str);
};

class SC_CORE_SEISMOLOGY_API LocatorException : public Core::GeneralException {
	public:
		LocatorException();
		LocatorException(const std::string& str);
};

class SC_CORE_SEISMOLOGY_API StationNotFoundException : public Core::GeneralException {
	public:
