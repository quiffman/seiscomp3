...
class SC_CORE_CLIENT_API ApplicationStatusMessage : public Core::Message {
...
struct SC_CORE_CLIENT_API Notification {
...
/** \brief Application class to write commandline clients easily using
  ...
  */
class SC_CORE_CLIENT_API Application : public Seiscomp::Core::InterruptibleObject {
	// ----------------------------------------------------------------------
	//  Public types
	// ----------------------------------------------------------------------
	public:
	...
	public:
		 ...
		 */
		bool configGetBool(const std::string& query) const throw(ConfigException);
		int configGetInt(const std::string& query) const throw(ConfigException);
		double configGetDouble(const std::string& query) const throw(ConfigException);
		std::string configGetString(const std::string& query) const throw(ConfigException);

		std::vector<bool> configGetBools(const std::string& query) const throw(ConfigException);
		std::vector<int> configGetInts(const std::string& query) const throw(ConfigException);
		std::vector<double> configGetDoubles(const std::string& query) const throw(ConfigException);
		std::vector<std::string> configGetStrings(const std::string& query) const throw(ConfigException);
