...
class SC_CORE_CLIENT_API PluginRegistry {	
	// ----------------------------------------------------------------------
	// Public types
	// ----------------------------------------------------------------------
	public:
		...
		class SC_CORE_CLIENT_API iterator : public std::list<PluginEntry>::const_iterator {
			private:
	...
	public:
		 ...
		 * @return The number of loaded plugins
		 */
		int loadConfiguredPlugins(const Config *config);
