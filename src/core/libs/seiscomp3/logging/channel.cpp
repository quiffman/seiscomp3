...
// We'll use
SC_CORE_LOGGING_API Channel *_SCDebugChannel = getGlobalChannel("debug", LL_DEBUG);
SC_CORE_LOGGING_API Channel *_SCInfoChannel = getGlobalChannel("info", LL_INFO);
SC_CORE_LOGGING_API Channel *_SCWarningChannel = getGlobalChannel("warning", LL_WARNING);
SC_CORE_LOGGING_API Channel *_SCErrorChannel = getGlobalChannel("error", LL_ERROR);
SC_CORE_LOGGING_API Channel *_SCNoticeChannel = getGlobalChannel("notice", LL_NOTICE);
