...
SC_CORE_LOGGING_API void debug(const char*);
SC_CORE_LOGGING_API void info(const char*);
SC_CORE_LOGGING_API void warning(const char*);
SC_CORE_LOGGING_API void error(const char*);
SC_CORE_LOGGING_API void notice(const char*);
SC_CORE_LOGGING_API void log(Channel*, const char* format);


/** NOTE: All retrieved Channel pointer must not be deleted!!! */

/** Retrieve all messages from all components */
SC_CORE_LOGGING_API Channel* getAll();

/** Retrieve messages from a channel of a all components */
SC_CORE_LOGGING_API Channel* getGlobalChannel(const char* channel, LogLevel level = LL_UNDEFINED);

/** Retrieve messages from a channel of a given component */
SC_CORE_LOGGING_API Channel* getComponentChannel(const char* component, const char* channel, LogLevel level = LL_UNDEFINED);

/** Retrieve defined messages from a component */
SC_CORE_LOGGING_API Channel* getComponentAll(const char* component);
SC_CORE_LOGGING_API Channel* getComponentDebugs(const char* component);
SC_CORE_LOGGING_API Channel* getComponentInfos(const char* component);
SC_CORE_LOGGING_API Channel* getComponentWarnings(const char* component);
SC_CORE_LOGGING_API Channel* getComponentErrors(const char* component);
SC_CORE_LOGGING_API Channel* getComponentNotices(const char* component);
...
SC_CORE_LOGGING_API Output* consoleOutput();
SC_CORE_LOGGING_API void enableConsoleLogging(Channel*);
SC_CORE_LOGGING_API void disableConsoleLogging();

SC_CORE_LOGGING_API void init(int &argc, char **argv);
