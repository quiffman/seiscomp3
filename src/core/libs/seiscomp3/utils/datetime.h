 ...
 */
SC_CORE_UTILS_API double timeOfDay(const Seiscomp::Core::Time& time);
 ...
 * @return The number of seconds including microseconds
 */
SC_CORE_UTILS_API double timeOfDay();
...
SC_CORE_UTILS_API bool getTime(const Core::Time& time, TimeVal& tv);

SC_CORE_UTILS_API void setTime(Core::Time& time, const TimeVal& tv);
