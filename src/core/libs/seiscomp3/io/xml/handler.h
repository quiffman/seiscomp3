...
struct SC_CORE_IO_API NodeHandler;

class SC_CORE_IO_API OutputHandler {
	public:
...
class SC_CORE_IO_API MemberNodeHandler;
...
struct SC_CORE_IO_API MemberHandler {
...
struct SC_CORE_IO_API TypeHandler {
...
struct SC_CORE_IO_API TypeNameHandler : public TypeHandler {
...
struct SC_CORE_IO_API MemberNodeHandler {
	MemberNodeHandler() {}
...
struct SC_CORE_IO_API ClassHandler : public NodeHandler {
