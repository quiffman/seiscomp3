...
class SC_CORE_IO_API AHRecord : public Record {
...
SC_CORE_IO_API AHRecord* read_one(std::istream &is);
SC_CORE_IO_API bool write_one(AHRecord *rec, std::ostream &os);
