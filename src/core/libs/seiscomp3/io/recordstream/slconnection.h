...
class SC_CORE_IO_API SeedlinkException: public Seiscomp::IO::RecordStreamException {
    public:
...
class SC_CORE_IO_API SeedlinkCommandException: public SeedlinkException {
    public:
...
class SC_CORE_IO_API SLConnection : public Seiscomp::IO::RecordStream {
