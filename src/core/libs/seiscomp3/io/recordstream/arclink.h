...
class SC_CORE_IO_API ArclinkException: public Seiscomp::IO::RecordStreamException {
	public:
...
class SC_CORE_IO_API ArclinkCommandException: public ArclinkException {
	public:
...
class SC_CORE_IO_API ArclinkConnection : public Seiscomp::IO::RecordStream {
