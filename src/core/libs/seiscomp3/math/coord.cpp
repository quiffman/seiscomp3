...
template struct SC_CORE_MATH_API Coord<float>;
template struct SC_CORE_MATH_API Coord<double>;

template class SC_CORE_MATH_API NamedCoord<float>;
template class SC_CORE_MATH_API NamedCoord<double>;

template class SC_CORE_MATH_API City<float>;
template class SC_CORE_MATH_API City<double>;
// <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
