...
class SC_CORE_MATH_API AlignmentError : public std::exception
{
  public:
...
class SC_CORE_MATH_API InPlaceFilter : public Core::BaseObject {
	public:
...
template<typename TYPE>
class SC_CORE_MATH_API SelfFilter : public InPlaceFilter<TYPE> {
	public:
		SelfFilter() {}
...
SC_CORE_MATH_API long next_power_of_2(long);
