...
template<class TYPE>
TimeDomain_from_T0_h<TYPE>::TimeDomain_from_T0_h(double T0, double h, double _gain)
	: T0(T0), h(h) { TimeDomain<TYPE>::gain=_gain; }
...
Filtering::InPlaceFilter<TYPE>* TimeDomain_from_T0_h<TYPE>::clone() const {
	return new TimeDomain_from_T0_h<TYPE>(T0, h, TimeDomain<TYPE>::gain);
}
...
template<class TYPE>
TimeDomain_from_T1_T2<TYPE>::TimeDomain_from_T1_T2(double T1, double T2, double _gain)
	: T1(T1), T2(T2) { TimeDomain<TYPE>::gain = _gain; }
...
Filtering::InPlaceFilter<TYPE>* TimeDomain_from_T1_T2<TYPE>::clone() const {
	return new TimeDomain_from_T1_T2<TYPE>(T1, T2, TimeDomain<TYPE>::gain);
}
...
template class SC_CORE_MATH_API TimeDomain_from_T0_h<float>;
template class SC_CORE_MATH_API TimeDomain_from_T0_h<double>;

template class SC_CORE_MATH_API TimeDomain_from_T1_T2<float>;
template class SC_CORE_MATH_API TimeDomain_from_T1_T2<double>;
