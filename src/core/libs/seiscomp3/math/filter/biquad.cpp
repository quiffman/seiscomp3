...
template class SC_CORE_MATH_API Biquad<float>;
template class SC_CORE_MATH_API Biquad<double>;

template class SC_CORE_MATH_API BiquadCascade<float>;
template class SC_CORE_MATH_API BiquadCascade<double>;
