...
InitialTaper<TYPE>::InitialTaper(double taperLength, TYPE offset)
...
{
	return new InitialTaper<TYPE>(_taperLength, _offset);
}
...
INSTANTIATE_INPLACE_FILTER(InitialTaper, SC_CORE_MATH_API);
