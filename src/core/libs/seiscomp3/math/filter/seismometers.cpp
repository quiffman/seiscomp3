...
INSTANTIATE_INPLACE_FILTER(Filter, SC_CORE_MATH_API);
...
INSTANTIATE_INPLACE_FILTER(WWSSN_SP_Filter, SC_CORE_MATH_API);
...
INSTANTIATE_INPLACE_FILTER(WWSSN_LP_Filter, SC_CORE_MATH_API);
...
INSTANTIATE_INPLACE_FILTER(WoodAndersonFilter, SC_CORE_MATH_API);
...
INSTANTIATE_INPLACE_FILTER(Seismometer5secFilter, SC_CORE_MATH_API);
...
INSTANTIATE_INPLACE_FILTER(GenericSeismometer, SC_CORE_MATH_API);
