...
//---------------------------------------------------------------------------
template class SC_CORE_MATH_API Tensor2N<float>;
template class SC_CORE_MATH_API Tensor2N<double>;

template class SC_CORE_MATH_API Tensor2S<float>;
template class SC_CORE_MATH_API Tensor2S<double>;

template class SC_CORE_MATH_API Spectral2S<float>;
template class SC_CORE_MATH_API Spectral2S<double>;
