...
#include <seiscomp3/communication/api.h>
 ...
 * peer.
 */
class SC_CORE_COMMUNICATION_API SyncRequestMessage : public Seiscomp::Core::Message {
 ...
 */
class SC_CORE_COMMUNICATION_API SyncResponseMessage : public Seiscomp::Core::Message {
 ...
 * fileaccess, ...).
 */
class SC_CORE_COMMUNICATION_API ServiceRequestMessage : public Seiscomp::Core::Message {
 ...
 */
class SC_CORE_COMMUNICATION_API ServiceProvideMessage : public Seiscomp::Core::Message {
 ...
 */
class SC_CORE_COMMUNICATION_API DatabaseRequestMessage : public ServiceRequestMessage {
 ...
 * \endcode
 */
class SC_CORE_COMMUNICATION_API DatabaseProvideMessage : public ServiceProvideMessage {
