...
#ifndef __SC_CORE_RECORD_H__
#define __SC_CORE_RECORD_H__
...
class SC_CORE_CORE_API Record : public Seiscomp::Core::BaseObject {
...
SC_CORE_CORE_API std::istream& operator>>(std::istream &is, Seiscomp::Record &rec);
SC_CORE_CORE_API std::ostream& operator<<(std::ostream &os, Seiscomp::Record &rec);
