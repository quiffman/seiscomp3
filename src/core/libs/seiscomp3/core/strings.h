...
SC_CORE_CORE_API std::string toString(const std::string& value);
SC_CORE_CORE_API std::string toString(bool value);
SC_CORE_CORE_API std::string toString(time_t value);
SC_CORE_CORE_API std::string toString(const Time& value);
SC_CORE_CORE_API std::string toString(const Enumeration& value);
...
SC_CORE_CORE_API bool fromString(time_t& value, const std::string& str);
SC_CORE_CORE_API bool fromString(Time& value, const std::string& str);
SC_CORE_CORE_API bool fromString(Enumeration& value, const std::string& str);
SC_CORE_CORE_API bool fromString(std::string& value, const std::string& str);
...
SC_CORE_CORE_API bool isEmpty(const char*);

/**
 * A case-insensitive comparison.
 * @return Result as defined by strcmp
 */
SC_CORE_CORE_API int compareNoCase(const std::string& a, const std::string& b);

/** Removes whitespace at the beginning and end of the string.
 * @param string to be trimmed (in/out parameter)
 * @return returns the trimmed string
 */
SC_CORE_CORE_API std::string& trim(std::string& str);
 ...
 */
SC_CORE_CORE_API bool wildcmp(const char *wild, const char *str);
SC_CORE_CORE_API bool wildcmp(const std::string &wild, const std::string &str);
