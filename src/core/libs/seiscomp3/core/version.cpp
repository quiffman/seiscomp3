...
extern SC_CORE_CORE_API const char* build_system();
extern SC_CORE_CORE_API const char* compiler_version();
extern SC_CORE_CORE_API const char* os_version();
#endif
