...
class SC_CORE_CORE_API Alarmable {
	public:
		Alarmable();
		virtual ~Alarmable();
...
class SC_CORE_CORE_API Interruptible {
	public:
		Interruptible();
...
class SC_CORE_CORE_API OperationInterrupted : public GeneralException {
	public:
...
class SC_CORE_CORE_API InterruptibleObject : public BaseObject, public Interruptible, public Alarmable {
