...
// >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
class SC_CORE_CORE_API PropertyNotFoundException : public GeneralException {
	public:
...
// >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
class SC_CORE_CORE_API MetaEnum {
	// ------------------------------------------------------------------
	//  Xstruction
	// ------------------------------------------------------------------
	public:
...
// >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
class SC_CORE_CORE_API MetaProperty {
	// ------------------------------------------------------------------
	//  Xstruction
	// ------------------------------------------------------------------
	public:
	...
	public:
		...
		//! Throws:
		//!  PropertyNotFoundException: The property does not exist
		virtual MetaValue read(BaseObject *object) const throw(GeneralException);
		...
		//! Throws:
		//!  PropertyNotFoundException: The property does not exist
		virtual std::string readString(BaseObject *object) const throw(GeneralException);
...
class SC_CORE_CORE_API MetaObject {
	// ----------------------------------------------------------------------
	//  Xstruction
	// ----------------------------------------------------------------------
	public:
