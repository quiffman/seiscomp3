...
class SC_CORE_CORE_API GapNotHandledException : public Core::GeneralException {
 public:
...
class SC_CORE_CORE_API MultiComponent: public Core::BaseObject {
...
class SC_CORE_CORE_API MultiComponentArray: public Core::BaseObject {
