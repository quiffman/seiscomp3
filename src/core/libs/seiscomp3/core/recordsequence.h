 ...
 */
class SC_CORE_CORE_API RecordSequence : public std::deque<RecordCPtr> // , public Record
{
	public:
...
class SC_CORE_CORE_API TimeWindowBuffer : public RecordSequence
{
	public:
...
class SC_CORE_CORE_API RingBuffer : public RecordSequence
{
	public:
