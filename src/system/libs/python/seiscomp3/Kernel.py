...
import os, sys, time, string, subprocess, seiscomp3.Config
...
class Environment(seiscomp3.Config.Config):
  def __init__(self, rootPath):
    ...
    try:
      LD_LIBRARY_PATH = os.environ["LD_LIBRARY_PATH"] + ":" + LD_LIBRARY_PATH
    except: pass
    ...
    try: os.makedirs(os.path.join(self.root, "var", "run"))
    except: pass
