...
* Settings for the Geotech DR-24 digitizer
...
*   25-bit samples (in case the digitizer gives more than 24 bits per sample);
* statusinterval (defaults to 0): time interval in minutes when "state of health"
