...
* Settings for the Earth Data PS2400/PS6-24 digitizer
...
* pctime (defaults to 0): use PC time for initial time setting if GPS
*   is not available. Not a good idea, unless testing (0: no, 1: yes);
* checksum (defaults to 0): whether the digitizer generates checksum
*   (0: no, 1: yes);
